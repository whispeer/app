...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sales__ = __webpack_require__(493);
...
var SalesPageModule = (function () {
    ...
    SalesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sales__["a" /* SalesPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_services_location_manager__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SalesPage = (function () {
    function SalesPage(navCtrl, statusBar, translate) {
        this.navCtrl = navCtrl;
        this.statusBar = statusBar;
        this.translate = translate;
        this.tutorialDisabled = true;
        this.business = Object(__WEBPACK_IMPORTED_MODULE_4__lib_services_location_manager__["c" /* isBusinessVersion */])();
        this.statusBar.styleDefault();
        if (!this.business) {
            this.goToBusiness();
        }
    }
    SalesPage.prototype.goToPrivateHome = function () {
        Object(__WEBPACK_IMPORTED_MODULE_4__lib_services_location_manager__["b" /* goToPrivateHome */])();
    };
    SalesPage.prototype.goToBusiness = function () {
    };
    SalesPage.prototype.getTranslation = function (key) {
    ...
    SalesPage = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-sales',template:/*ion-inline-start:"/Users/nilos/software/whispeer/messenger/src/pages/sales/sales.html"*/'<div class="sales__content">\n	<div class="sales__logo-wrap">\n		<img class="sales__logo" src="assets/images/logo_white.svg">\n	</div>\n\n	<div class="sales__main">\n		<div class="sales__main-title" [innerHtml]="\'sales.title\' | translate">\n		</div>\n		<div class="sales__main-text" [innerHtml]="\'sales.text\' | translate">\n		</div>\n		<div class="sales__callToAction">\n			<div class="sales__callToAction-text">\n				{{ \'sales.callToAction\' | translate }}\n			</div>\n			<div class="sales__callToAction-number">\n				<a href="tel:+493055597624">+49 (0) 30 - 55 59 76 24</a>\n			</div>\n		</div>\n		<div class="sales__main-finePrint" [innerHtml]="\'sales.finePrint\' | translate"></div>\n	</div>\n\n	<div class="sales__private" (click)="goToPrivateHome()">\n		<span [innerHtml]="\'login.privateUser\' | translate">\n		</span>\n		<ion-icon ios="ios-arrow-forward-outline"></ion-icon>\n	</div>\n</div>\n'/*ion-inline-end:"/Users/nilos/software/whispeer/messenger/src/pages/sales/sales.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */]])
    ], SalesPage);
    return SalesPage;
}());
