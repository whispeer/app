...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactRequestPageModule", function() { return ContactRequestPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contact_requests__ = __webpack_require__(481);
...
var ContactRequestPageModule = (function () {
    function ContactRequestPageModule() {
    }
    ContactRequestPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__contact_requests__["a" /* ContactRequestsPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__contact_requests__["a" /* ContactRequestsPage */]),
    ...
    return ContactRequestPageModule;
}());
...
var ContactRequestsPage = (function () {
    function ContactRequestsPage(navCtrl, navParams) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.requests = [];
        this.requestsLoading = true;
        this.loadRequestsUsers = function () {
        ...
        this.friendDividers = function (record, recordIndex, records) {
    ...
    ContactRequestsPage.prototype.ionViewDidLoad = function () {
        ...
        friendsService.awaitLoading().then(function () {
            friendsService.listen(_this.loadRequestsUsers);
            _this.loadRequestsUsers();
            _this.requestsLoading = false;
        });
    };
    ContactRequestsPage.prototype.checkRequest = function (userId) {
    ...
    ContactRequestsPage = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-contact-requests',template:/*ion-inline-start:"/Users/nilos/software/whispeer/messenger/src/pages/contact-requests/contact-requests.html"*/'<ion-header>\n\n	<ion-navbar [color]="\'primary\'">\n		<ion-title>{{ \'requests.title\' | translate }}</ion-title>\n	</ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n	<ion-spinner *ngIf="requestsLoading" text-center margin-vertical class="spinner--full"></ion-spinner>\n	<ion-list [virtualScroll]="requests" [headerFn]="friendDividers" class="friends__list">\n		<ion-item-divider *virtualHeader="let header" class="friends__divider">\n			{{ header }}\n		</ion-item-divider>\n\n		<ion-item *virtualItem="let requester" (click)="checkRequest(requester.id)">\n			<ion-avatar class="hexagon--border" item-left>\n				<user-image [id]="requester.id" [image]="requester.basic.image"></user-image>\n			</ion-avatar>\n			<h2>{{requester.name}}</h2>\n		</ion-item>\n	</ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/nilos/software/whispeer/messenger/src/pages/contact-requests/contact-requests.html"*/
        }),
