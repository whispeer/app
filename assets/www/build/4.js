...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add__ = __webpack_require__(523);
...
var AddPageModule = (function () {
    ...
    AddPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add__["a" /* AddPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_services_error_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_asset_memoizer__ = __webpack_require__(503);
var contactsService = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ngx_translate_core__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_angularUtils__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_messages_chat__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_contacts_contactsWithSearch__ = __webpack_require__(504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lib_helper_helper__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__lib_asset_memoizer__ = __webpack_require__(503);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_bluebird__ = __webpack_require__(3);
...
var AddPage = (function (_super) {
    ...
    function AddPage(navCtrl, navParams, platform, translate) {
        ...
        _this.removeSelectedUser = function (user) {
            __WEBPACK_IMPORTED_MODULE_6__lib_helper_helper__["default"].removeArray(_this.selectedUsers, user);
        ...
        _this.getFilteredUsers = function () {
            return _this.addMemoizer.getValue();
        };
        _this.getSelectedUsers = function () {
            return _this.selectedUsers.sort(function (a, b) {
                if (a.name > b.name) {
                    return 1;
                }
        ...
        _this.addReceivers = function () {
            _this.saving = true;
            __WEBPACK_IMPORTED_MODULE_8_bluebird__["resolve"](_this.selectedUsers).map(function (user) {
                return user.id;
            }).then(function (data) {
                return _this.chat.addReceivers(data);
            }).then(function () {
                Object(__WEBPACK_IMPORTED_MODULE_3__lib_angularUtils__["a" /* replaceView */])(_this.navCtrl, "Chat Details", { chatID: _this.chat.getID() }, 2);
            });
        };
        ...
        _this.addMemoizer = new __WEBPACK_IMPORTED_MODULE_7__lib_asset_memoizer__["a" /* default */]([
            function () { return _this.getUsers(); },
            function () { return _this.chat; },
        ], function (users, chat) {
            if (!chat) {
                return users;
            }
            return users.filter(function (u) { return chat.getReceiverIDs().indexOf(u.id) === -1; });
        });
        return _this;
    }
    AddPage.prototype.ngOnInit = function () {
        ...
        contactsService.awaitLoading().then(function () {
            contactsService.listen(_this.loadContactsUsers);
        ...
        initService.awaitLoading().then(function () {
            return __WEBPACK_IMPORTED_MODULE_4__lib_messages_chat__["b" /* default */].get(chatID);
        }).then(function (chat) {
            _this.chat = chat;
