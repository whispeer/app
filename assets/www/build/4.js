...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add__ = __webpack_require__(491);
...
var AddPageModule = (function () {
    ...
    AddPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add__["a" /* AddPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ngx_translate_core__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_messages_chat__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_contacts_contactsWithSearch__ = __webpack_require__(472);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_helper_helper__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lib_asset_memoizer__ = __webpack_require__(471);
...
var AddPage = (function (_super) {
    ...
    function AddPage(navCtrl, navParams, platform, translate) {
        ...
        _this.removeSelectedUser = function (user) {
            __WEBPACK_IMPORTED_MODULE_5__lib_helper_helper__["default"].removeArray(_this.selectedUsers, user);
        ...
        _this.addReceivers = function () {
            _this.saving = true;
            __WEBPACK_IMPORTED_MODULE_7_bluebird__["resolve"](_this.selectedUsers).map(function (user) {
                return user.id;
            }).then(function (data) {
                return _this.chat.addReceivers(data);
            }).then(function () {
                _this.navCtrl.push("Chat Details", { chatID: _this.chat.getID() }).then(function () {
                    _this.navCtrl.remove(_this.navCtrl.length() - 3, 2);
                });
            });
        };
        ...
        _this.addMemoizer = new __WEBPACK_IMPORTED_MODULE_6__lib_asset_memoizer__["a" /* default */]([
    ...
    AddPage.prototype.ngOnInit = function () {
        ...
        initService.awaitLoading().then(function () {
            return __WEBPACK_IMPORTED_MODULE_3__lib_messages_chat__["b" /* default */].get(chatID);
        }).then(function (chat) {
            _this.chat = chat;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["_13" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["m" /* Searchbar */]),
    ...
    AddPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* Platform */], __WEBPACK_IMPORTED_MODULE_0__ngx_translate_core__["c" /* TranslateService */]])
    ], AddPage);
    return AddPage;
}(__WEBPACK_IMPORTED_MODULE_4__lib_contacts_contactsWithSearch__["a" /* ContactsWithSearch */]));
