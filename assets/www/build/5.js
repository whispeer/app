...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contacts__ = __webpack_require__(518);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_contacts_contactsWithSearch__ = __webpack_require__(504);
...
var ContactsPage = (function (_super) {
    __extends(ContactsPage, _super);
    function ContactsPage(navCtrl, navParams, translate) {
        var _this = _super.call(this, translate) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.translate = translate;
        _this.requests = [];
        _this.handleSearchKey = function (event) {
            if (event.keyCode === 13) {
                event.target.blur();
            }
        };
    ...
    ContactsPage.prototype.ionViewDidLoad = function () {
        ...
        contactsService.awaitLoading().then(function () {
            ...
            contactsService.listen(function () {
                _this.requests = contactsService.getRequests();
                _this.loadContactsUsers();
            });
            return _this.loadContactsUsers().then(function () {
                _this.contactsLoading = false;
            });
        });
    };
    Object.defineProperty(ContactsPage.prototype, "requestsLabel", {
        get: function () {
    ...
    ContactsPage.prototype.goToUser = function (userId) {
        this.navCtrl.push("Profile", {
            userId: userId
        });
    };
    ContactsPage.prototype.goToRequests = function () {
