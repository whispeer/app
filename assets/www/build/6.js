...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__blockedUsers__ = __webpack_require__(516);
...
var ContactsPageModule = (function () {
    ...
    ContactsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__blockedUsers__["a" /* BlockedUsersPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__blockedUsers__["a" /* BlockedUsersPage */]),
...
//# sourceMappingURL=blockedUsers.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BlockedUsersPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_users_userService__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_services_settings_service__ = __webpack_require__(48);
...
var BlockedUsersPage = (function (_super) {
    __extends(BlockedUsersPage, _super);
    function BlockedUsersPage(navCtrl, translate) {
    ...
    BlockedUsersPage_1 = BlockedUsersPage;
    BlockedUsersPage.prototype.load = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_4__lib_services_settings_service__["default"].getBlockedUsers().length === 0) {
            //TODO remove this view from history
            var views = this.navCtrl.getViews().filter(function (_a) {
                var component = _a.component;
                return component === BlockedUsersPage_1;
            });
            views.forEach(function (view) { return _this.navCtrl.removeView(view); });
        }
        return __WEBPACK_IMPORTED_MODULE_3__lib_users_userService__["default"].getMultipleFormatted(__WEBPACK_IMPORTED_MODULE_4__lib_services_settings_service__["default"].getBlockedUsers().map(function (_a) {
            var id = _a.id;
            return id;
        }))
            .then(function (users) { return __WEBPACK_IMPORTED_MODULE_5__lib_contacts_contactsWithSearch__["a" /* ContactsWithSearch */].sort(users); })
            .then(function (users) {
            _this.contacts = users;
            _this.contactsLoading = false;
        });
    };
    BlockedUsersPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        initService.awaitLoading().then(function () { return _this.load(); });
        __WEBPACK_IMPORTED_MODULE_4__lib_services_settings_service__["default"].listen(function () { return _this.load(); }, "updated");
    };
    BlockedUsersPage.prototype.goToUser = function (userId) {
        this.navCtrl.push("Profile", {
            userId: userId
        });
    };
    BlockedUsersPage = BlockedUsersPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'blocked-users',template:/*ion-inline-start:"/Users/nilos/software/whispeer/messenger/src/pages/blocked-users/blockedUsers.html"*/`<ion-header>\n	<ion-navbar [color]="\'primary\'">\n		<ion-title>{{ \'blocked.title\' | translate }}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n\n<ion-content>\n	<ion-spinner *ngIf="contactsLoading" text-center margin-vertical class="spinner--full"></ion-spinner>\n	<ion-list [approxItemHeight]="\'50px\'" [virtualScroll]="getUsers()" [headerFn]="contactDividers" class="friends__list">\n		<ion-item-divider *virtualHeader="let header" class="friends__divider">\n			{{ header }}\n		</ion-item-divider>\n\n		<ion-item *virtualItem="let contact" (click)="goToUser(contact.id)" detail-push>\n			<ion-avatar class="hexagon--border"\n					[ngClass]="{\'hexagon__image--active\': contact.online}" item-left>\n				<user-image [hideBlocked]="false" [id]="contact.id" [image]="contact.basic.image"></user-image>\n			</ion-avatar>\n			<h2>\n				<span>\n					{{contact.names.originalName}}\n				</span>\n			</h2>\n		</ion-item>\n\n	</ion-list>\n\n	<div class="explanation space-for-fab">\n		<p class="text-grey">\n			{{ \'blocked.listExplanation\' | translate}}<br>\n		</p>\n	</div>\n\n	<navigator [icon]="\'close\'" (invoke)="close()" ion-fixed></navigator>\n</ion-content>\n`/*ion-inline-end:"/Users/nilos/software/whispeer/messenger/src/pages/blocked-users/blockedUsers.html"*/
        }),
